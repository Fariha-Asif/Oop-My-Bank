...
let demoAccounts: number[] = [1001, 1002, 1003, 1004, 1005];
...
//Bank Account Class
class BankAccount implements BankAccountint{
    accountNumber: number;
    balance: number;
...
class Customer {
    ...
    constructor(firstName: string, lastName:string, gendre: string, age: number, mobileNumber: number, account: BankAccount){
